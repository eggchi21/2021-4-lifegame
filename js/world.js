...
export class LifeWorld {
    ...
    createBlock() {
        ...
        for (var i = 0; i < count; i++) {
            for (var j = 0; j < count; j++) {
                this._board.clear(j + this.lineCells * i);
            }
        }
        this._board.set(2 + this.lineCells * 2);
        this._board.set(3 + this.lineCells * 2);
        this._board.set(2 + this.lineCells * 3);
        this._board.set(3 + this.lineCells * 3);
    };
    ...
    createBlinker() {
        ...
        this._board.set(2 + this.lineCells * 2);
        this._board.set(2 + this.lineCells * 3);
        this._board.set(2 + this.lineCells * 4);
    };
    ...
    createGlider() {
        ...
        this._board.set(2 + this.lineCells * 2);
        this._board.set(3 + this.lineCells * 2);
        this._board.set(4 + this.lineCells * 2);
        this._board.set(2 + this.lineCells * 3);
        this._board.set(3 + this.lineCells * 4);
    };
}
